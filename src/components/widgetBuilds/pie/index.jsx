      ...
      <>
        <el-collapse>
          ...
          {/* <el-collapse-item title="饼图设置">
            <zu-form-item label="设置为环形">
              <el-switch v-model={formData.series[0].radius} />
            </zu-form-item>
            <zu-form-item label="南丁格尔玫瑰">
          ...
          <el-collapse-item title="图例设置">
            ...
            <zu-form-item label="图例上下居中">
              <el-select v-model={formData.legend.y} placeholder="Select" size="mini">
